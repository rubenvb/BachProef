...
Hier wordt gebruik gemaakt van een berekening waar een initïele toestand %$\mathcal{F}^{(0}$ werd geëvolueerd met behulp van de BK vergelijking \cite{F0}.
...
\end{align}
% bad ones
%\Phi_{\mathcal{F}\text{, zonder evolutie}}(k^2, Q^2) &= \int_0^1 \int_0^1 \frac{e_q^2 k^2 Q^2 (1-2\rho(1-\rho)-2\eta(1-\eta)+12\rho(1-\rho)\eta(1-\eta)}{4\pi^2 2(\eta(1-\eta)k^2 + \rho(1-\rho)Q^2)} \\
%\Phi_{\mathcal{F}\text{, met evolutie} &= \int_0^1 \int_0^1 \frac{e_q^2 \alpha_S(k^2 R^2) k^2 R^2 Q^2 2\pi (1-2\rho(1-\rho)-2\eta(1-\eta)+12\rho(1-\rho)\eta(1-\eta))e^{-\frac{\log{k^2 R^2}^2}{2\times 48 \alpha_S(k^2 R^2)\log{frac{.1}{x}}}}}{4\pi^2 2
