...
De LHeC zal (door zijn hogere botsingsenergie) buiten dit gebied kunnen meten en dus een duidelijke indicatie geven van fenomenen zoals saturatie die nu niet duidelijk kunnen worden gemeten.
    ...
    \subsubsection{Evolutievergelijkingen \textit{vs} experimentele data}
...
Een handig theorema dat toelaat de perturbatieve en niet-perturbatieve delen van een theoretische berekening van elkaar te scheiden.
...
Om met zekerheid te kunnen spreken over de resultaten van deze berekeningen en een definitieve grens te kunnen trekken tussen DGLAP en BFKL 
