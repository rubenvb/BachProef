...
Deze kan dus binnen het model beschouwd worden als extra correctie.
    ...
    \subsubsection{$\mathcal{F}_2$} \label{sec:UGDPhoton}
...
Figuur \ref{fig:ETDiagram} (b) toont de begintoestand, namelijk de \textit{quark doos}, die werd aangenomen als beginvoorwaarde bij het oplossen van de BFKL vergelijking.
...
Zo kan men met behulp van de BK vergelijking een betere 
...
\centering
\subfigure{
\includegraphics[scale=.49]{afbeeldingen/FLQ12.eps}
}
\subfigure{
\includegraphics[scale=.49]{afbeeldingen/FLQ15.eps}
}
\subfigure{
\includegraphics[scale=.49]{afbeeldingen/FLQ20.eps}
}
\subfigure{
\includegraphics[scale=.49]{afbeeldingen/FLQ25.eps}
}
...
Voor $Q^2$ gelijk aan 15 en 25 GeV is er een discrepantie, maar aangezien deze willekeurig lijkt te zijn, heeft dit geen effect op de juistheid van het resultaat.
...
\centering
\subfigure{
\includegraphics[scale=.49]{afbeeldingen/Placeholder.eps}
}
\subfigure{
\includegraphics[scale=.49]{afbeeldingen/Placeholder.eps}
}
...
Onze berekening is gefit geweest aan data. (nood aan herfit aan nieuwe data).
